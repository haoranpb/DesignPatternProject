...
public class Build {
    ...
    protected void setBuildStrat(BuildingType buildingType) {
        if (buildingType == BuildingType.SIMP) {
            bdstr = new SimpleBuildStrat();
        } else if (buildingType == BuildingType.EXQU) {
            bdstr = new ExquisiteBuildStrat();
        } else if (buildingType == BuildingType.LUXU) {
            bdstr = new LuxuryBuildStrat();
        }
    }
